...
export const clientsMarqueeUrl = [
  { href: "src/assets/hpcl.svg", label: "Hindusthan Petroleum" },
  { href: "src/assets/iocl.svg", label: "Indian Oil" },
  { href: "src/assets/shell.svg", label: "Shell" },
  { href: "src/assets/bpcl.svg", label: "Bharat Petroleum" },
  { href: "src/assets/jio.svg", label: "Jio" },
  { href: "src/assets/kvb.svg", label: "Karur Vysya Bank" },
];
