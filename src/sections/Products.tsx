function Products() {
  ...
  return (
    <>
      ...
      <div className=" px-6  py-4 space-y-4 container max-container flex flex-1  flex-col items-center justify-center ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-6">
          {/* <div className="bg-white  flex flex-col space-y-2 rounded-lg">
            ...
            />
            <span className="text-center">Smart Padlock</span>
            ...
            <div className="p-2">
              <Button className="" color="blue" fullWidth mt="md" radius="md">
                Buy now
              </Button>
            </div>
          </div> */}
